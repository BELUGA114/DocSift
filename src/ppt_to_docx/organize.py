...
def organize_content(
    ...
    payload = client.text_json([item.model_dump(mode="json") for item in extractions], ORGANIZE_PROMPT, OrganizationPayload)
    organization = Organization.model_validate(payload.model_dump())
